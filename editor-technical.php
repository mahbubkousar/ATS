...
$templateName = 'technical'; // Fixed template for this editor
...
<head>
    ...
    <title>Utechnical Resume Editor - ResumeSync</title>
...
<body class="editor-body">
    ...
    <div class="editor-container">
        ...
        <aside class="editor-sidebar left-sidebar">
            ...
            <h2 class="sidebar-section-title">Utechnical Resume</h2>

            <!-- Resume Title -->
            <div class="form-section">
                <h3 class="form-section-title">Resume Title</h3>
                <input type="text" class="form-input" id="resumeTitle" placeholder="e.g., Utechnical Professional Resume" value="<?php echo htmlspecialchars($resumeData['resume_title'] ?? ''); ?>">
            </div>
            ...
            <div class="form-section">
                ...
                <div class="locked-template-display">
                    ...
                    <span id="currentTemplateName">Utechnical</span>
            ...
            <!-- Skills -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-star"></i> Technical Skills</h3>
                <textarea class="form-textarea" id="skills" placeholder="Enter your technical skills by category&#10;&#10;Languages: JavaScript, Python, Java&#10;Frameworks: React, Node.js, Django&#10;Tools: Git, Docker, AWS" rows="6"></textarea>
                <small class="form-hint">Organize skills by category for better readability</small>
            </div>
            ...
            <!-- Certifications -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-certificate"></i> Certifications</h3>
        ...
        <main class="resume-preview">
            <div class="template-header">
                <span class="template-label">Template: <span id="currentTemplateNameDisplay">Technical</span></span>
            </div>
    ...
    <script src="js/editor-technical.js?v=2"></script>
</body>
</html>
