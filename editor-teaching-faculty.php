...
$templateName = 'teaching-faculty'; // Fixed template for this editor
...
<head>
    ...
    <title>Teaching Faculty Resume Editor - ResumeSync</title>
...
<body class="editor-body">
    ...
    <div class="editor-container">
        ...
        <aside class="editor-sidebar left-sidebar">
            ...
            <h2 class="sidebar-section-title">Teaching Faculty Resume</h2>
            ...
            <div class="form-section">
                ...
                <div class="locked-template-display">
                    ...
                    <span id="currentTemplateName">Teaching Faculty</span>
            ...
            <!-- Teaching Philosophy -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-lightbulb"></i> Teaching Philosophy</h3>
                <textarea class="form-textarea" id="teachingPhilosophy" placeholder="Describe your teaching philosophy and approach..." rows="5"></textarea>
            </div>

            <!-- Courses Taught -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-chalkboard-user"></i> Courses Taught</h3>
                <div id="coursesContainer"></div>
                <button class="add-item-btn" id="addCourseBtn">
            ...
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-book"></i> Research & Publications</h3>
            ...
            <!-- Service & Committees -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-users"></i> Service & Committee Work</h3>
                <textarea class="form-textarea" id="service" placeholder="Enter committee work and service activities&#10;&#10;• Chair, Curriculum Development Committee&#10;• Faculty Senate Member&#10;• Student Advising Committee" rows="4"></textarea>
            </div>

            <!-- Skills & Expertise -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-star"></i> Areas of Expertise</h3>
                <textarea class="form-textarea" id="skills" placeholder="Enter your areas of expertise and teaching specializations&#10;&#10;e.g., Educational Technology, Curriculum Design, Assessment Methods" rows="3"></textarea>
            </div>

            <!-- Teaching Awards -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-award"></i> Teaching Awards & Recognition</h3>
                <textarea class="form-textarea" id="awards" placeholder="Enter teaching awards and recognition&#10;&#10;• Excellence in Teaching Award 2023&#10;• Outstanding Faculty Award 2022" rows="3"></textarea>
            </div>
            ...
            <div class="form-section">
                ...
                <button class="add-item-btn" id="addReferenceBtn">
        ...
        <main class="resume-preview">
            <div class="template-header">
                <span class="template-label">Template: <span id="currentTemplateNameDisplay">Teaching Faculty</span></span>
            </div>
    ...
    <script src="js/editor-teaching-faculty.js?v=2"></script>
</body>
</html>
