...
$templateName = 'executive'; // Fixed template for this editor
...
<head>
    ...
    <title>Uexecutive Resume Editor - ResumeSync</title>
...
<body class="editor-body">
    ...
    <div class="editor-container">
        ...
        <aside class="editor-sidebar left-sidebar">
            ...
            <h2 class="sidebar-section-title">Uexecutive Resume</h2>

            <!-- Resume Title -->
            <div class="form-section">
                <h3 class="form-section-title">Resume Title</h3>
                <input type="text" class="form-input" id="resumeTitle" placeholder="e.g., Uexecutive Professional Resume" value="<?php echo htmlspecialchars($resumeData['resume_title'] ?? ''); ?>">
            </div>
            ...
            <div class="form-section">
                ...
                <div class="locked-template-display">
                    ...
                    <span id="currentTemplateName">Uexecutive</span>
            ...
            <!-- Skills -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-star"></i> Core Competencies</h3>
                <textarea class="form-textarea" id="skills" placeholder="Enter your core competencies, separated by commas&#10;&#10;e.g., Strategic Planning, P&L Management, M&A, Business Transformation, Team Leadership" rows="4"></textarea>
                <small class="form-hint">Focus on executive-level competencies</small>
            </div>

            <!-- Key Achievements -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-trophy"></i> Key Achievements</h3>
                <textarea class="form-textarea" id="achievements" placeholder="Enter quantifiable achievements (one per line)&#10;&#10;• Increased revenue by 150% over 3 years&#10;• Led successful acquisition of 3 companies worth $500M&#10;• Built and scaled team from 50 to 300+ employees" rows="6"></textarea>
            </div>

            <!-- Board Memberships -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-users"></i> Board Memberships & Advisory Roles</h3>
                <div id="boardContainer"></div>
                <button class="add-item-btn" id="addBoardBtn">
                    <i class="fa-solid fa-plus"></i> Add Board Membership
                </button>
            </div>

            <!-- Certifications & Awards -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-award"></i> Certifications & Awards</h3>
                <textarea class="form-textarea" id="awards" placeholder="Enter notable certifications and awards&#10;&#10;e.g., MBA - Harvard Business School&#10;CEO of the Year 2023 - Industry Association" rows="4"></textarea>
            </div>
        </aside>
        ...
        <main class="resume-preview">
            <div class="template-header">
                <span class="template-label">Template: <span id="currentTemplateNameDisplay">Executive</span></span>
            </div>
    ...
    <script src="js/editor-executive.js?v=1"></script>
</body>
</html>
