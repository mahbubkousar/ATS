...
$templateName = 'creative'; // Fixed template for this editor
...
<head>
    ...
    <title>Ucreative Resume Editor - ResumeSync</title>
...
<body class="editor-body">
    ...
    <div class="editor-container">
        ...
        <aside class="editor-sidebar left-sidebar">
            ...
            <h2 class="sidebar-section-title">Ucreative Resume</h2>

            <!-- Resume Title -->
            <div class="form-section">
                <h3 class="form-section-title">Resume Title</h3>
                <input type="text" class="form-input" id="resumeTitle" placeholder="e.g., Ucreative Professional Resume" value="<?php echo htmlspecialchars($resumeData['resume_title'] ?? ''); ?>">
            </div>
            ...
            <div class="form-section">
                ...
                <div class="locked-template-display">
                    ...
                    <span id="currentTemplateName">Ucreative</span>
            ...
            <!-- Skills -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-star"></i> Skills & Tools</h3>
                <textarea class="form-textarea" id="skills" placeholder="Enter your creative skills and tools&#10;&#10;Design: Adobe Creative Suite, Figma, Sketch&#10;Motion: After Effects, Premiere Pro&#10;3D: Blender, Cinema 4D" rows="5"></textarea>
                <small class="form-hint">Include software and creative disciplines</small>
            </div>
            ...
            <div class="form-section">
                ...
                <button class="add-item-btn" id="addPortfolioBtn">
            ...
            <!-- Exhibitions & Awards -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-award"></i> Exhibitions & Awards</h3>
                <textarea class="form-textarea" id="awards" placeholder="Enter notable exhibitions, awards, and recognition&#10;&#10;• Best Design Award 2023 - Design Association&#10;• Featured in Creative Review Magazine&#10;• Solo Exhibition at Modern Art Gallery" rows="5"></textarea>
            </div>

            <!-- Website & Social Links -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-link"></i> Online Presence</h3>
                <input type="text" class="form-input" id="portfolioWebsite" placeholder="Portfolio Website URL">
                <input type="text" class="form-input" id="behance" placeholder="Behance Profile URL">
                <input type="text" class="form-input" id="dribbble" placeholder="Dribbble Profile URL">
                <input type="text" class="form-input" id="instagram" placeholder="Instagram Handle">
            </div>
        </aside>
        ...
        <main class="resume-preview">
            <div class="template-header">
                <span class="template-label">Template: <span id="currentTemplateNameDisplay">Creative</span></span>
            </div>
    ...
    <script src="js/editor-creative.js?v=1"></script>
</body>
</html>
