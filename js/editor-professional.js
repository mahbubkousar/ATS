// Professional Template Editor JavaScript
// This is a dedicated editor for the Professional resume template
...
function setupEventListeners() {
    ...
    // Skills - Professional template uses categorized skills
...
function parseSkillCategories(skillsText) {
    ...
    lines.forEach(line => {
        if (line.includes(':')) {
            ...
            // If no category, add as general skills
