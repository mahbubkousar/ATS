// Research Scientist Template Editor JavaScript
// This is a dedicated editor for the Research Scientist resume template

let resumeState = {
    id: resumeData.id,
    resume_title: resumeData.resume_title,
    template_name: 'research-scientist',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load the research-scientist template
    loadTemplatePreview();
...
function loadTemplatePreview() {
    ...
    previewIframe.src = `/ATS/templates/research-scientist.html?v=${timestamp}`;
...
async function saveResume() {
    ...
    try {
        ...
        formData.append('template_name', 'research-scientist');
