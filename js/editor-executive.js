// Uexecutive Template Editor JavaScript
// This is a dedicated editor for the Uexecutive resume template
...
function loadTemplatePreview() {
    ...
    previewIframe.src = `/ATS/templates/executive.html?v=${timestamp}`;
...
async function saveResume() {
    ...
    try {
        ...
        formData.append('template_name', 'executive');
