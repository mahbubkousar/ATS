// Teaching Faculty Template Editor JavaScript
// This is a dedicated editor for the Teaching Faculty resume template

let resumeState = {
    id: resumeData.id,
    resume_title: resumeData.resume_title,
    template_name: 'teaching-faculty',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load the teaching-faculty template
    loadTemplatePreview();
...
function loadTemplatePreview() {
    ...
    previewIframe.src = `/ATS/templates/teaching-faculty.html?v=${timestamp}`;
...
async function saveResume() {
    ...
    try {
        ...
        formData.append('template_name', 'teaching-faculty');
