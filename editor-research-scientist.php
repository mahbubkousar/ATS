...
$templateName = 'research-scientist'; // Fixed template for this editor
...
<head>
    ...
    <title>Research Scientist Resume Editor - ResumeSync</title>
...
<body class="editor-body">
    ...
    <div class="editor-container">
        ...
        <aside class="editor-sidebar left-sidebar">
            ...
            <h2 class="sidebar-section-title">Research Scientist Resume</h2>
            ...
            <div class="form-section">
                ...
                <div class="locked-template-display">
                    ...
                    <span id="currentTemplateName">Research Scientist</span>
            ...
            <!-- Research Interests -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-microscope"></i> Research Focus</h3>
                <textarea class="form-textarea" id="researchInterests" placeholder="Describe your primary research focus and areas of investigation..." rows="4"></textarea>
            </div>

            <!-- Publications -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-book"></i> Selected Publications</h3>
            ...
            <!-- Research Projects -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-flask"></i> Research Projects</h3>
                <div id="projectsContainer"></div>
                <button class="add-item-btn" id="addProjectBtn">
                    <i class="fa-solid fa-plus"></i> Add Research Project
                </button>
            </div>
            ...
            <!-- Technical Skills -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-star"></i> Technical Skills & Methods</h3>
                <textarea class="form-textarea" id="skills" placeholder="Enter research methods and technical skills&#10;&#10;Methods: CRISPR, Flow Cytometry, PCR, Mass Spectrometry&#10;Analysis: Python, R, MATLAB, ImageJ&#10;Techniques: Cell Culture, Microscopy, Western Blotting" rows="5"></textarea>
            </div>

            <!-- Presentations & Conferences -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-presentation"></i> Conferences & Presentations</h3>
                <textarea class="form-textarea" id="presentations" placeholder="List notable conference presentations&#10;&#10;• Keynote Speaker - International Science Conference 2023&#10;• Oral Presentation - Annual Research Symposium 2022" rows="4"></textarea>
            </div>

            <!-- Awards & Honors -->
            <div class="form-section">
                <h3 class="form-section-title"><i class="fa-solid fa-award"></i> Awards & Honors</h3>
                <textarea class="form-textarea" id="awards" placeholder="Enter notable awards and honors&#10;&#10;• NSF CAREER Award 2023&#10;• Young Investigator Award 2022" rows="3"></textarea>
            </div>
        </aside>
        ...
        <main class="resume-preview">
            <div class="template-header">
                <span class="template-label">Template: <span id="currentTemplateNameDisplay">Research Scientist</span></span>
            </div>
    ...
    <script src="js/editor-research-scientist.js?v=1"></script>
</body>
</html>
